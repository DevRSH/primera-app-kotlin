...
fun QuestionScreen(
    ...
    val hasFeedback = state.feedbackText != null
    ...
    Column(
        ...
        q.options.forEachIndexed { index, option ->
            ...
            ElevatedCard(
                modifier = Modifier
                    .fillMaxWidth()
                    .clickable {
                        if (!hasFeedback) onSelectedOption(index)
                    },
        ...
        if (hasFeedback) {
            Text(
                ...
                color = if (state.feedbackText?.startsWith("✅") == true) Color(0xFF2E7D32) else Color(0xFFC62828)
            )
        }
        ...
        if (!hasFeedback) {
            ...
            Button(
                ...
                Text(if (isLastQuestion) "Ver resultados" else "Continuar")
            }
        }
